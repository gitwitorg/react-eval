...
You're welcome to use this framework with your own code generation tool. By default it comes with [GitWit](https://github.com/gitwitorg/gitwit-server).

You can answer questions like:
- Does the ReactJS code generated by X LLM or agent build/run/give errors? Does it look correct?
- Which LLMs/agents generate the gest ReactJS code?

And you can batch run these questions with hundreds of prompts, while storing screenshots of the results.
...
To run a test with the built-in prompt dataset:
